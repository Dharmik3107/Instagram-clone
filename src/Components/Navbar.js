        ...
        <div className={styles.navDiv}>
          <div className={styles.sizeDiv}>
            <div className={styles.textLogo}>
              <a className={styles.textIcon} href="/" tabindex="0">
                <svg
            ...
            <div className={styles.navIcons}>
              <div className={styles.buttonSpreader}>
                <a className={styles.homeIcon} href="/" tabindex="0">
                  <svg
                    aria-label="Home"
                    class="_ab6-"
                    color="#262626"
                ...
                <a className={styles.exploreIcon} href="/explore/" tabindex="0">
                  <svg
                ...
                <a className={styles.activityIcon} href="/accounts/activity/">
                  <svg
                ...
                <a className={styles.profileIcon} href="/accounts/activity/">
